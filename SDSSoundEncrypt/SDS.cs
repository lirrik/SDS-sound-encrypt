...
namespace SDSSoundEncrypt
{
    ...
    class SDS
    {
        ...
        // Modificator to convert 16-bit samples signed integers [-32768; 32767] to [-1.0; 1.0] range
        ...
        /// <summary>
        /// Reverse calculation of c3 value - decrypted sound sample.
        /// </summary>
        ...
        /// <returns>c3 (SDS parameter) reverse value</returns>
